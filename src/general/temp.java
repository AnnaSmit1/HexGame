...
//        if (row >= 0 && row < DIM && col >= 0 && col < DIM && oneColorFields[row][col] == color) {
//            oneColorFields[row][col] = Color.CHECKED;
//            for (int k = 0; k < 6; k++) {
...
//        oneColorFields = new Board();
//        if (color == Color.RED) {
//            for (int j = 0; j < 9; j++) {
//                this.oneColorFields = singleColorCopy(color).fields;
//                Fill(0, j, color);
//                for (int m = 0; m < 9; m++) {
//                    if (oneColorFields[8][m] == Color.CHECKED) {
//                        return true;
//                    }
//                }
//            }
...
//            for (int j = 0; j < 9; j++) {
//                oneColorFields = singleColorCopy(color).fields;
//                Fill(0, j, color);
//                for (int m = 0; m < 9; m++) {
//                    System.out.println("J: " + j);
//                    if (oneColorFields[m][8] == Color.CHECKED) {
//                        return true;
//                    }
//                }
//            }
